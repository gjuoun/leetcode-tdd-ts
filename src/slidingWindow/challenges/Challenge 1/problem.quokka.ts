...
// console.log(permutation_in_a_string_qk('bcdxabcdy', 'bcdyabcdx'));
// console.log(permutation_in_a_string_qk('oidbcaf', 'abc'));
// console.log(permutation_in_a_string_qk('odicf', 'dc'));
